...
import { transpose } from '@/lib/street-parking/osm-tag-updater/transpose/transpose'
import { TagsStringArray } from '@/lib/street-parking/osm-tag-updater/transpose/types'
